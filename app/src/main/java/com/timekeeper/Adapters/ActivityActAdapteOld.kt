...
class ActivityActAdapter(val main: MainActivity, val context: Context, private val myActivities: List<Activity>, val data: SQLiteDatabase?) : RecyclerView.Adapter<ActivityActAdapter.MyViewHolder>() {
