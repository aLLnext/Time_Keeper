...
//        holder.cur_timerbase.base = ( - current.current_time)
//        holder.cur_time.base = (((SystemClock.elapsedRealtime() - System.currentTimeMillis() + Calendar.getInstance().timeInMillis) - current.timer_base) - current.current_time)
    }
